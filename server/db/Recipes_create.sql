...
-- Table: photos_recipes
CREATE TABLE photos_recipes (
    id int  NOT NULL,
    image bytea  NOT NULL,
    recipes_id int  NOT NULL,
    CONSTRAINT photos_recipes_pk PRIMARY KEY (id)
);
...
-- Reference: photos_recipes_recipes (table: photos_recipes)
ALTER TABLE photos_recipes ADD CONSTRAINT photos_recipes_recipes
    FOREIGN KEY (recipes_id)
    REFERENCES recipes (id)  
    NOT DEFERRABLE 
    INITIALLY IMMEDIATE
